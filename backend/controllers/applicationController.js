...
export const postApplication = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    const application = await Application.create({
      ...
      applicantID,
      employerID,
      jobId: jobDetails._id, // ← save the job reference so we can populate title later
      resume: {
...
export const employerGetAllApplications = catchAsyncErrors(
  async (req, res, next) => {
    ...
    // populate jobId so the frontend can display the job title
...
export const jobseekerGetAllApplications = catchAsyncErrors(
  async (req, res, next) => {
    ...
    // populate jobId so the job seeker can also see which job they applied for
    const applications = await Application.find({
